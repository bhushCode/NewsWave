...
class TopHeadlinesFragment : Fragment() {
   ...
   lateinit var shimmer: ShimmerFrameLayout
    ...
    override fun onCreateView(
        ...
        sportsReView = view.findViewById(R.id.topHeadLines_recView)
      progressBar = view.findViewById(R.id.topHeadLines_progressBar)
        shimmer= view.findViewById<ShimmerFrameLayout>(R.id.shimmer_layout_topheadlines)
        shimmer.startShimmer()
      //  progressBar.visibility=View.VISIBLE
        adapter = NewsAdapter()

        val newsApi = RetrofitHelper().getInstance().create(NewsApi::class.java)
        val repository = NewsRepository(newsApi,"technology",requireContext())
