...
class TechnologyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sportsReView = view.findViewById(R.id.technology_recyclerveiw)

        progressBar = view.findViewById(R.id.technology_progressBar)
      shimmer= view.findViewById(R.id.shimmer_layout_technology)
