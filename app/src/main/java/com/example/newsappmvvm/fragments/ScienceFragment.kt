...
class ScienceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sportsReView = view.findViewById(R.id.science_Fragment)
        progressBar = view.findViewById(R.id.science_progressBar)
        shimmer = view.findViewById(R.id.shimmer_layout_science)
        ...
        val repository = NewsRepository(newsApi,"science",requireContext())
