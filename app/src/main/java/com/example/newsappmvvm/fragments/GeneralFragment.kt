...
class GeneralFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sportsReView = view.findViewById(R.id.general_recview)
          shimmer = view.findViewById(R.id.shimmer_layout_general)
        shimmer.startShimmer()
        progressBar = view.findViewById(R.id.general_progressBar)
      //  progressBar.visibility = View.VISIBLE
        ...
        val repository = NewsRepository(newsApi,"general",requireContext())
